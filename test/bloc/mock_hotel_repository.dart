  ...
  Future<List<HotelModel>> fetchHotels() async {
    return Future.value([
      HotelModel(
          ...
          price: 10,
          imageUrl: 'https://q-cf.bstatic.com/images/hotel/max1024x768/209/209735787.jpg',
          rooms: [],
          amenities: [],
          description: '',
          reviews: []),
      HotelModel(
          ...
          price: 20,
          imageUrl: 'https://q-cf.bstatic.com/images/hotel/max1024x768/163/163564419.jpg',
          rooms: [],
          amenities: [],
          description: '',
          reviews: []),
      ...
      HotelModel(
          ...
          price: 40,
          imageUrl: 'https://thumbs.dreamstime.com/b/pasillo-del-hotel-39479289.jpg',
          rooms: [],
          amenities: [],
          description: '',
          reviews: []),
